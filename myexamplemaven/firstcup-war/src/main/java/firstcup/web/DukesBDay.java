...
/**
 * DukesBDay is a CDI managed bean that acts as a backing bean. A managed bean
 * is a lightweight container-managed object that supports a set of basic
 * services. A backing bean is a managed bean that provides temporary data
 * storage for the values of the components included on a particular JavaServer
 * Faces page. The JavaServer Faces application instantiates the managed bean
 * and stores it in scope.
 *
 *
 */
@Named
...
public class DukesBDay implements Serializable {
    ...
    /**
     * Get duke's current age through web service
     *
